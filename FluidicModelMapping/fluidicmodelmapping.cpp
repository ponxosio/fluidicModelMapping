...
bool FluidicModelMapping::areCompatible(std::shared_ptr<ProtocolGraph> graph) {
    AnalysisExecutor protocolAnalysis(graph, model->getDefaultRate() * model->getDefaultRateUnits());
